...
class AlgoApplication: Application() {
    ...
    val title: String = "TwoWayQuick Sort Visualization"
    ...
    private lateinit var data: TwoWayQuickSortData
    val render =  { dataTwoWay: TwoWayQuickSortData ->
        this.data = dataTwoWay
        paint()
    }
